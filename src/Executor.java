...
public class Executor 
{
	...
	public static void main(String[] args) throws InterruptedException, ExecutionException 
	{
	    ...
	    for(int i = 0; i < 2; i++) 
	    {
			...
			if(taskTwo.get() == null) {
				System.out.println(i+1 + ") TaskTwo of Dice Thrown terminated successfully");
			} else {
				// if it doesn't finished, cancel it
				taskTwo.cancel(true);
			}
			if(taskThree.get() == null) {
				System.out.println(i+1 + ") TaskThree of Dice Thrown terminated successfully");
			} else {
	    ...
	    System.out.println("All Tasks and Threads of Dice are finished!");
	}
